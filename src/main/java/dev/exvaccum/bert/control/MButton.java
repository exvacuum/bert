...
public class MButton extends Rectangle{
    ...
    private Font fnt = Bert.mBert.biosFont;
    ...
    public void setBordered(boolean bordered){
     ...
     public boolean containsMouse(){
        return contains(Bert.mBert.input.mouseLocation.getX()-owner.getX()-owner.getInsets().left, Bert.mBert.input.mouseLocation.getY()-owner.getY()-owner.getInsets().top);
     }
